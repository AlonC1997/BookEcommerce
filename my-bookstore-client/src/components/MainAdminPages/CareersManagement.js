	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.leftPanel}>
				...
				<input type="text" className={styles.search} placeholder="Search by ID, title, category, or location" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
			</div>
			...
			{isModalOpen && (
				<div className={styles.modal}>
					<div className={styles.modalContent}>
						...
						<input type="text" placeholder="Title" value={newCareer.title} onChange={(e) => setNewCareer({ ...newCareer, title: e.target.value })} />
						<input type="text" placeholder="Description" value={newCareer.description} onChange={(e) => setNewCareer({ ...newCareer, description: e.target.value })} />
						<input type="text" placeholder="Category" value={newCareer.category} onChange={(e) => setNewCareer({ ...newCareer, category: e.target.value })} />
						<input type="text" placeholder="Location" value={newCareer.location} onChange={(e) => setNewCareer({ ...newCareer, location: e.target.value })} />
						<input type="text" placeholder="Level" value={newCareer.level} onChange={(e) => setNewCareer({ ...newCareer, level: e.target.value })} />
						<input type="text" placeholder="Requirements" value={newCareer.requirements} onChange={(e) => setNewCareer({ ...newCareer, requirements: e.target.value })} />
						<input type="date" placeholder="Date Posted" value={newCareer.datePosted} onChange={(e) => setNewCareer({ ...newCareer, datePosted: e.target.value })} />
						<label>
							<input type="checkbox" checked={newCareer.available} onChange={(e) => setNewCareer({ ...newCareer, available: e.target.checked })} />
							Available
						</label>
			...
			<div className={styles.tableContainer}>
					...
					<tbody>
						{filteredCareers(careers).map((career) => (
							<tr key={career.id}>
								<td>{career.id}</td>
								<td>
									<input type="text" value={career.title} onChange={(e) => handleInputChange(e, career.id, 'title')} />
								</td>
								<td>
									<input type="text" value={career.description} onChange={(e) => handleInputChange(e, career.id, 'description')} />
								</td>
								<td>
									<input type="text" value={career.category} onChange={(e) => handleInputChange(e, career.id, 'category')} />
								</td>
								<td>
									<input type="text" value={career.location} onChange={(e) => handleInputChange(e, career.id, 'location')} />
								</td>
								<td>
									<input type="text" value={career.level} onChange={(e) => handleInputChange(e, career.id, 'level')} />
								</td>
								<td>
									<input type="text" value={career.requirements} onChange={(e) => handleInputChange(e, career.id, 'requirements')} />
								</td>
								<td>
				...
				<button onClick={handleUpdateAll} className={styles.updateAllButton}>
					Update All
				</button>
			</div>
						...
						{fileList.map((file) => (
							<tr key={file.id}>
								...
								<td>
									...
									<button onClick={() => handleViewFile(file.id)} className={styles.downloadButton}>
										Download
									</button>
								</td>
							</tr>
