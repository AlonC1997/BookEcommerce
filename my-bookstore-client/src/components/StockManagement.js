  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.leftPanel}>
        <button className={styles.addButton} onClick={() => setIsModalOpen(true)}>Add New Book</button>
        ...
        <div className={styles.filters}>
          ...
          <label>
            <input
              type="checkbox"
              checked={showNoMoreForSale}
              onChange={(e) => setShowNoMoreForSale(e.target.checked)}
            />
            No More for Sale
          </label>
        </div>
        ...
        <input
          ...
          placeholder="Search by ID, name, category, or author"
          value={searchTerm}
        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <input
              ...
              value={newBook.img_link}
              onChange={(e) => setNewBook({ ...newBook, img_link: e.target.value })}
            />
            <input
              type="text"
                ...
                {filteredBooks(inStockBooks).map((book, index) => (
                  <tr key={book.id}>
                    ...
                    <td>
                      ...
                      <button className={styles.updateButton} onClick={() => handleUpdateBook(book)}>Update</button>
                    </td>
                  </tr>
                ))}
              </tbody>
              ...
              <tbody>
                {filteredBooks(noMoreForSaleBooks).map((book, index) => (
                  <tr key={book.id}>
                    ...
                    <td>
                      <button className={styles.restoreButton} onClick={() => handleRestoreBook(book.id)}>Restore</button>
                      <button className={styles.updateButton} onClick={() => handleUpdateBook(book)}>Update</button>
                    </td>
                  </tr>
                ))}
